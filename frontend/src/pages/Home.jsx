  ...
  return (
    <div className="home-container">
      {/* HEADER: GLOBAL HEALTH */}
        ...
        {/* SEÇÃO: MAPA DE TOPOLOGIA DE REDE */}
        <style>{`
          ...
          .network-node-card:hover {
            transform: translate(-50%, -55%) scale(1.03) !important;
            border-color: var(--color-accent) !important;
            box-shadow: 0 4px 15px rgba(56, 189, 248, 0.15) !important;
          }
          .network-node-card-center:hover {
            transform: translate(-50%, -50%) scale(1.02) !important;
          }
        `}</style>

        <div className="stat-box-industrial" style={{ padding: '24px', marginBottom: '32px', display: 'flex', flexDirection: 'column', gap: '16px', background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
          <div>
            <h3 style={{ fontSize: '1.15rem', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '8px', margin: 0, color: 'var(--color-text)' }}>
              <Globe size={18} color="var(--color-accent)" />
              Topologia de Rede & Ativos (Klarke Map)
            </h3>
            <p style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', margin: '4px 0 0 0' }}>
              Visualização lógica das conexões e integridade dos nós em tempo real.
            </p>
          </div>

          <div style={{ position: 'relative', width: '100%', height: '320px', background: 'rgba(0,0,0,0.15)', border: '1px solid var(--color-border)', borderRadius: '0px', overflow: 'hidden' }}>
            {/* SVG Connection Lines */}
            <svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
              {/* Background static lines */}
              <line x1="50%" y1="50%" x2="20%" y2="22%" stroke="rgba(255,255,255,0.05)" strokeWidth="3" />
              <line x1="50%" y1="50%" x2="20%" y2="78%" stroke="rgba(255,255,255,0.05)" strokeWidth="3" />
              <line x1="50%" y1="50%" x2="80%" y2="22%" stroke="rgba(255,255,255,0.05)" strokeWidth="3" />
              <line x1="50%" y1="50%" x2="80%" y2="78%" stroke="rgba(255,255,255,0.05)" strokeWidth="3" />

              {/* Active flowing lines */}
              <line x1="50%" y1="50%" x2="20%" y2="22%" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="6,4" style={{ animation: 'flow-line-dash 1.5s linear infinite' }} />
              <line x1="50%" y1="50%" x2="20%" y2="78%" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="6,4" style={{ animation: 'flow-line-dash 1.5s linear infinite' }} />
              <line x1="50%" y1="50%" x2="80%" y2="22%" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="6,4" style={{ animation: 'flow-line-dash 1.5s linear infinite' }} />
              <line x1="50%" y1="50%" x2="80%" y2="78%" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="6,4" style={{ animation: 'flow-line-dash 1.5s linear infinite' }} />
            </svg>

            {/* Central Node: VPS Gateway */}
            <div 
              className="network-node-card network-node-card-center"
              style={{
                position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
                background: '#1e293b', border: '2px solid var(--color-accent)', padding: '12px 18px',
                borderRadius: '0px', textAlign: 'center', zIndex: 10, display: 'flex', flexDirection: 'column',
                alignItems: 'center', gap: '4px', boxShadow: '0 0 20px rgba(56, 189, 248, 0.25)', minWidth: '150px'
              }}
            >
              <Globe size={18} color="var(--color-accent)" />
              <span style={{ fontSize: '0.75rem', fontWeight: 'bold', letterSpacing: '0.5px', color: 'white' }}>GATEWAY VPS</span>
              <span style={{ fontSize: '0.65rem', color: '#10b981', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 'bold' }}>
            ...
            <div 
              ...
              style={{
                position: 'absolute', top: '22%', left: '20%', transform: 'translate(-50%, -50%)',
                background: 'var(--color-primary-light)', border: '1px solid var(--color-border)', padding: '8px 12px',
                borderRadius: '0px', textAlign: 'center', display: 'flex', flexDirection: 'column',
                alignItems: 'center', gap: '2px', minWidth: '130px', cursor: 'pointer'
              }} 
              onClick={() => navigate('/control/voip')}
            >
              <Phone size={16} color="var(--color-accent)" />
              <span style={{ fontSize: '0.7rem', fontWeight: 'bold', color: 'var(--color-text)' }}>RAMAIS VOIP</span>
              <span style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)' }}>{stats.voip || 0} ramais</span>
              <span style={{ fontSize: '0.6rem', color: '#10b981', fontWeight: '600' }}>ONLINE</span>
            </div>

            {/* Node: Dispositivos de Rede */}
            <div 
              className="network-node-card"
              style={{
                position: 'absolute', top: '78%', left: '20%', transform: 'translate(-50%, -50%)',
                background: 'var(--color-primary-light)', border: '1px solid var(--color-border)', padding: '8px 12px',
                borderRadius: '0px', textAlign: 'center', display: 'flex', flexDirection: 'column',
                alignItems: 'center', gap: '2px', minWidth: '130px', cursor: 'pointer'
              }} 
              onClick={() => navigate('/control/network')}
            >
              <RouterIcon size={16} color="var(--color-accent)" />
              <span style={{ fontSize: '0.7rem', fontWeight: 'bold', color: 'var(--color-text)' }}>ATIVOS DE REDE</span>
              <span style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)' }}>{stats.networkOnline}/{stats.network} online</span>
              <span style={{ fontSize: '0.6rem', color: '#10b981', fontWeight: '600' }}>ESTÁVEL</span>
            </div>
            ...
            <div 
              className="network-node-card"
              style={{
                position: 'absolute', top: '22%', left: '80%', transform: 'translate(-50%, -50%)',
                background: 'var(--color-primary-light)', border: '1px solid var(--color-border)', padding: '8px 12px',
                borderRadius: '0px', textAlign: 'center', display: 'flex', flexDirection: 'column',
                alignItems: 'center', gap: '2px', minWidth: '130px', cursor: 'pointer'
              }} 
              onClick={() => navigate('/control/cameras')}
            >
              <Camera size={16} color="var(--color-accent)" />
              <span style={{ fontSize: '0.7rem', fontWeight: 'bold', color: 'var(--color-text)' }}>SISTEMA CFTV</span>
              <span style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)' }}>{stats.camerasOnline}/{stats.cameras} online</span>
              <span style={{ fontSize: '0.6rem', color: '#10b981', fontWeight: '600' }}>ATIVAS</span>
            </div>
            ...
            <div 
              className="network-node-card"
              style={{
                position: 'absolute', top: '78%', left: '80%', transform: 'translate(-50%, -50%)',
                background: 'var(--color-primary-light)', border: '1px solid var(--color-border)', padding: '8px 12px',
                borderRadius: '0px', textAlign: 'center', display: 'flex', flexDirection: 'column',
                alignItems: 'center', gap: '2px', minWidth: '130px', cursor: 'pointer'
              }} 
              onClick={() => navigate('/control/machines')}
            >
              <Monitor size={16} color="var(--color-accent)" />
              <span style={{ fontSize: '0.7rem', fontWeight: 'bold', color: 'var(--color-text)' }}>ESTAÇÕES (PCS)</span>
              <span style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)' }}>{stats.machinesOnline}/{stats.machines} online</span>
              <span style={{ fontSize: '0.6rem', color: '#10b981', fontWeight: '600' }}>OPERACIONAL</span>
            </div>
        </div>
      </div>
