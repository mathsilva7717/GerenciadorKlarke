...
import { Search, Plus, X, Copy, Router as RouterIcon, MapPin, Check, Download, Clipboard, Trash2 } from 'lucide-react';
...
function NetworkDevices() {
  ...
  const exportToCSV = () => {
    const headers = ['ID', 'Nome', 'Tipo', 'IP', 'Local', 'Operadora', 'Usuário', 'Senha', 'Criado em'];
    const rows = devices.map(d => [
      d.id, d.name, d.type, d.ip, d.location, d.isp, d.username, d.password, d.created_at
    ]);
      ...
      <div className="search-wrapper">
        <div className="search-container">
          ...
          <input 
            ...
            placeholder="Buscar equipamento, IP, operadora..." 
            value={searchTerm}
